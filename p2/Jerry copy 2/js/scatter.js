...
var timeoutId;
  ...
  var descriptions = {
    ...
    .html(function(d) {
    //  console.log(d);
      return "<span style='color:red'>Agency</span> : " + d.Agency + "<br>" + "<span style='color:red'>Category</span> : " + d.Category+"<br><span style='color:red'>Detail</span> : "+
      d.Detail+"<br><span style='color:red'>Vendor</span> :"+
             d.Vendor+"<br><span style='color:red'>Times of sale</span> : "+sameVender.length+"<br><span style='color:red'>Payments</span> : $"+d3.format(",")(d.Payments);
    });



  var xScale, yScale;
var legendSVG = d3.select("#colorLegend").append("svg").attr("id","colorLegendSVG").attr("width", 400).attr("height",500);
...
d3.tsv('data/salesNew.tsv', function(da) {
  ...
  d3.select('svg g.chart')
    ...
    .style('fill','red')
    .attr({'id': 'xLabel', 'x': 600, 'y': 740, 'text-anchor': 'middle'})
  ...
  d3.select('svg g.chart')
    .append("g")
    .attr('transform', 'translate(-26, 780)')
    .attr('id', 'xAxis')
    .call(makeXAxis)
    .selectAll("text")  
  ...
  d3.select('svg g.chart')
    ...
    dropDownDetails.on("change", function() {
      ...
      $("#slider1").slider('values',1,401);
      $("#slider2").slider('values',0,699.79);
      console.log(document.getElementById('selectVendors'))
...
function updateChart(init) {
  ...
  // console.log("in updateChart");
  var legendSVG = d3.select("#colorLegend").append("svg").attr("id","colorLegendSVG").attr("width", 500).attr("height",350);
