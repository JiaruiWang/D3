...
d3.csv('sales1.csv', function(data) {
...
var sameVender;
  ...
  var legendSVG = d3.select("#colorLegend").append("svg").attr("id","colorLegendSVG").attr("width", 270).attr("height",1000);
  ...
  var dropDownVendors = d3.select("#filter1").append("select")
                    .attr("name", "selectVendors");
  var dropDownDetails = d3.select("#filter2").append("select")
